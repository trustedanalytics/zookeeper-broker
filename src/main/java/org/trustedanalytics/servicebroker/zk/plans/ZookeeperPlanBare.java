...
@Component("bare")
class ZookeeperPlanBare implements ServicePlanDefinition {

  private ZookeeperSimpleBindingOperations zookeeperSimpleBindingOperations;

  @Autowired
  public ZookeeperPlanBare(ZookeeperSimpleBindingOperations zookeeperSimpleBindingOperations){
  ...
  public Map<String, Object> bind(ServiceInstance serviceInstance) throws ServiceBrokerException {
    return zookeeperSimpleBindingOperations.getBareCredentialsMap();
  }
}
